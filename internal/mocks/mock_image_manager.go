...
// Source: image_manager_interface.go
//
// Generated by this command:
//
//	mockgen -source image_manager_interface.go -destination ../mocks/mock_image_manager.go -package mocks
//
...
func (mr *MockImageManagerMockRecorder) BuildImageFromDockerfile(ctx, dockerfilePath, imageName any) *gomock.Call {
...
func (mr *MockImageManagerMockRecorder) CheckTheImageAvailable(ctx, image any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImageManagerMockRecorder) PullImage(ctx, image any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
