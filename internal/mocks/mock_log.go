...
func (m *MockLog) Printf(format string, v ...interface{}) {
	m.ctrl.T.Helper()
...
func (mr *MockLogMockRecorder) Printf(format interface{}, v ...interface{}) *gomock.Call {
...
func (mr *MockLogMockRecorder) Println(v ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
