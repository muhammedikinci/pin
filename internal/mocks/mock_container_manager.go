...
// Source: container_manager_interface.go
//
// Generated by this command:
//
//	mockgen -source container_manager_interface.go -destination ../mocks/mock_container_manager.go -package mocks
//
...
func (mr *MockContainerManagerMockRecorder) CopyFromContainer(ctx, containerID, srcPath, destPath any) *gomock.Call {
...
func (mr *MockContainerManagerMockRecorder) CopyToContainer(ctx, containerID, workDir, copyIgnore any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerManagerMockRecorder) RemoveContainer(ctx, containerID, forceRemove any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerManagerMockRecorder) StartContainer(ctx, name, image, ports, env any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerManagerMockRecorder) StopContainer(ctx, containerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
